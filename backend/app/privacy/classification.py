...
_NON_RLS: tuple[NonRlsTable, ...] = (
    ...
    *(_n(f"ref.{t}", N.GLOBAL_REFERENCE_OR_REGISTRY, _GRANTS_RO,
      ...
      for t in ("account_registered_type", "asset_category", "condition_operator",
                "currency", "deadline_type", "document_type", "employment_type",
                "expense_category", "housing_status", "income_type", "jurisdiction",
                "liability_category", "marital_status", "province",
                "residency_status", "rule_category", "tax_year",
                "verification_status")),
    *(_n(f"rules.{t}", N.GLOBAL_REFERENCE_OR_REGISTRY, _GRANTS_RO,
      ...
      for t in ("calc_constant", "calc_formula", "calc_formula_input",
                ...
                "formula_vector", "rule_action", "rule_condition",
                "rule_condition_group", "rule_deadline", "rule_dependency",
                "rule_example", "rule_outcome", "rule_required_document",
                "rule_shared_resource")),
